...
export const PLACEMENT_LINES = Object.freeze({
  rising: Object.freeze({
    aries: 'as the rising sign it fronts the encounter — the first read off this sheet is directness, arriving before any history does.',
    ...
    gemini: 'as the rising sign it fronts the encounter — the first read off this sheet is quickness of exchange, ahead of whatever settles later.',
    ...
    aquarius: 'as the rising sign it fronts the encounter — the first read off this sheet is distance on principle, the stance before the warmth.',
  ...
  innerAnimal: Object.freeze({
    rat: 'as the private animal it runs off-stage — with the audience gone, the working mode is quiet resourcefulness, stores counted twice.',
    ...
    tiger: 'as the private animal it runs off-stage — with the audience gone, the working mode is appetite for the risk not yet announced.',
    rabbit: 'as the private animal it runs off-stage — with the audience gone, the working mode is soft-footed caution, exits noted early.',
    ...
    snake: 'as the private animal it runs off-stage — with the audience gone, the working mode is strategy held close, moves unshown.',
    horse: 'as the private animal it runs off-stage — with the audience gone, the working mode is restlessness without an audience to pace for.',
    ...
    monkey: 'as the private animal it runs off-stage — with the audience gone, the working mode is tinkering, the trick refined before it is shown.',
    ...
    pig: 'as the private animal it runs off-stage — with the audience gone, the working mode is ease taken plainly, comfort without apology.',
  }),
});
