...
## Repository shape
    ...
    content/      cards.v1.full.js (144-card deck, JS-gated per §1 v0.22) + meanings.v1.js (58 tradition-cited entries, §1.G v0.44) + concordance.v1.js (finite relation registry, §1.H v0.50)
