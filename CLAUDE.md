...
## Repository shape
    ...
    core/         pure functions — 13 modules (profile, engine, rising, birthcard, pillars, countries, calendar, cities, payments, math, public, dyad, moon)
    ...
    tests/        54 vitest files + fixtures.json + helpers/ (dom.js, voice-register.js — de-forked shared scan tables/mocks, non-test modules per §7)
