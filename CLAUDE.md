...
## Repository shape
    ...
    tests/        59 vitest files + fixtures.json + helpers/ (dom.js, voice-register.js, js-lex.js — de-forked shared scan tables/mocks plus a JS lexical classifier for the static source guards, non-test modules per §7)
