...
- **(a)** the shared artifact contains only the free coordinate symbols, their section labels, and the catalog number, plus the bare production URL — never the paid card-content layer (name/type/habit/note), never name or DOB;
