...
const EXPECTED_CODES = Object.freeze([
  ...
  'ss48_virgo-x-sagittarius', 'ss52_libra-x-scorpio', 'ss56_libra-x-pisces', 'ss60_scorpio-x-pisces', 'ss64_capricorn-x-aquarius',
  't00_the-fool', 'e1_wood', 's01_aries', 'a01_rat', 'n01_number-1',
  't01_the-magician', 'e2_fire', 's02_taurus', 'a02_ox', 'n02_number-2',
  't02_the-high-priestess', 'e3_earth', 's03_gemini', 'a03_tiger', 'n03_number-3',
  't03_the-empress', 'e4_metal', 's04_cancer', 'a04_rabbit', 'n04_number-4',
  't04_the-emperor', 'e5_water', 's05_leo', 'a05_dragon', 'n05_number-5',
  't05_the-hierophant', 's06_virgo', 'a06_snake', 'n06_number-6', 't06_the-lovers',
  's07_libra', 'a07_horse', 'n07_number-7', 't07_the-chariot', 's08_scorpio',
  'a08_goat', 'n08_number-8', 't08_strength', 's09_sagittarius', 'a09_monkey',
  'n09_number-9', 't09_the-hermit', 's10_capricorn', 'a10_rooster', 'n11_number-11',
  't10_wheel-of-fortune', 's11_aquarius', 'a11_dog', 'n22_number-22', 't11_justice',
  's12_pisces', 'a12_pig', 'n33_number-33', 't12_the-hanged-man', 't13_death',
  't14_temperance', 't15_the-devil', 't16_the-tower', 't17_the-star', 't18_the-moon',
  't19_the-sun', 't20_judgement', 't21_the-world', 'ee01_wood-x-fire', 'ee05_water-x-wood',
  'ee09_metal-x-wood', 'aed03_tiger-x-wood', 'aed07_horse-x-fire', 'aed11_dog-x-earth', 'aex03_rat-x-earth',
  'aex07_ox-x-metal', 'aex11_tiger-x-metal', 'aex15_rabbit-x-metal', 'aex19_dragon-x-metal', 'aex23_snake-x-metal',
  ...
  'aex08_ox-x-water', 'aex12_tiger-x-water', 'aex16_rabbit-x-water', 'aex20_dragon-x-water', 'aex24_snake-x-water',
  'aex28_horse-x-water', 'aex32_goat-x-water', 'aex36_monkey-x-water', 'aex40_rooster-x-water', 'aex44_dog-x-water',
  'aex48_pig-x-metal', 'aa17_rabbit-x-dragon', 'aa21_rabbit-x-pig', 'aa25_snake-x-monkey', 'aa29_horse-x-dog',
  'aa33_rooster-x-dog', 'ss17_taurus-x-scorpio', 'ss21_taurus-x-pisces', 'ss25_gemini-x-libra', 'ss29_gemini-x-aquarius',
  'ss33_cancer-x-libra', 'ss37_cancer-x-aquarius', 'ss41_leo-x-scorpio', 'ss45_leo-x-pisces', 'ss49_virgo-x-capricorn',
  ...
  'aa11_ox-x-dog', 'aa13_tiger-x-horse', 'aa14_tiger-x-monkey', 'aa18_rabbit-x-goat', 'aa22_dragon-x-monkey',
  'aa26_snake-x-rooster', 'aa30_goat-x-dog', 'ss14_taurus-x-leo', 'ss18_taurus-x-sagittarius', 'ss22_gemini-x-cancer',
  'ss26_gemini-x-scorpio', 'ss30_gemini-x-pisces', 'ss34_cancer-x-scorpio', 'ss38_cancer-x-pisces', 'ss42_leo-x-sagittarius',
