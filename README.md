...
├── ui/                      9 DOM-touching ES modules — init*UI({refs}, {hooks}) DI shape per §6 v0.23
...
│   ├── share_surface / readings / payments_markup / payments_state / facet_rotation / feedback_surface / modals  UI surfaces + state
